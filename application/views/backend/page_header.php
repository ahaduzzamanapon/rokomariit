      ...
      <section class="sidebar">
        ...
        <li class="treeview <?= backend_activate_menu_class('product'); ?>">
          ...
          <ul class="treeview-menu">
            ...
            <li class="treeview <?= backend_activate_menu_class('page'); ?>">
              <a href="javascript:void();">
                <i class="fa fa-dashboard"></i> <span>Pages</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span>
              </a>
              <ul class="treeview-menu">
                <li><a href="<?= base_url('admin/pages/add'); ?>"><i class="fa fa-circle-o"></i> Add Page</a></li>
                <li><a href="<?= base_url('admin/pages/all'); ?>"><i class="fa fa-circle-o"></i> All Page</a></li>
              </ul>
            </li>
