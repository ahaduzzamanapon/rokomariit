                                     ...
                                     <div class="div-table">
                                         <div class="div-cell">
                                             <div class="caption-content btn-grad">
                                                 <a href="tel:+8801775-015791">
                                                     <h3 class="caption-subtitle">Call Now</h3>
                                                 </a>
                     ...
                     <div class="col-lg-4 col-md-12 col-sm-12">
                         ...
                         <div class="box-part text-center">
                             ...
                             <div class="title text-center">
                                 <a href="<?= base_url() ?>service/<?= $item->slug ?>">
                                     <h3 style="color:black;"><b><?= $item->name; ?></b></h3>
                                 </a>
     ...
     <div class="container">
         <div class="row">
             <div class="col-lg-4 col-md-4 col-sm-4">
                 ...
                 <h5 style="color:black; font-family: 'Roboto', sans-serif;"><i class="fa fa-map-marker" style="color:black;"></i>&nbsp;&nbsp;&nbsp;P.R.Tower , 924/1 , Level 8 Begum Rokeya,<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Prof. Abdullah Sarani, Dhaka 1216</p>
                 </h5>
