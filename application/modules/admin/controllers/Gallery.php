...
class Gallery extends Backend_Controller {
	...
	public function __construct(){
        ...
        $this->img_path = realpath(APPPATH . '../gallery_img');
    }
    ...
    public function all(){
        $this->data['results'] = $this->Common_model->get_data('gallery'); 
	...
	public function add(){
        ...
        if ($this->form_validation->run() == true){
            ...
            if($this->Common_model->save('gallery', $form_data)){                
        ...
        // view
		$this->data['meta_title'] = 'Add Gallery';
