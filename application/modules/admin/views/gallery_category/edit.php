    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          ...
          <a href="<?=base_url('admin/gallerycategory/all')?>" class="btn btn-info btn-xs pull-right" style="margin-left: 15px;"> All Gallery Category</a>
          <a href="<?=base_url('admin/gallerycategory/add')?>" class="btn btn-info btn-xs pull-right"> Add Gallery Category</a> 
        </div>        
        <?php echo form_open_multipart("admin/gallerycategory/edit/".$info->id);?>
          <div class="box-body">            
