          ...
          <div class="row">
            <div class="col-md-8">
              <table class="table table-bordered table-striped table-responsive">
                ...
                <tr>
                  <td class="col-md-2">Video</td>
                  <td class="col-md-1">:</td>
                  <td class="col-md-4">
                    <iframe
                      src="https://www.youtube.com/embed/<?= $package->package_video ?>?playlist=<?= $package->package_video ?>&loop=1"
                      frameborder="0"
                      allowfullscreen>
                    </iframe>
                  </td>
                ...
                <tr>
                  <td class="col-md-2">Video Title 1</td>
                  <td class="col-md-1">:</td>
                  <td class="col-md-4"><?= $package->package_video_title_1 ?></td>
                </tr>
                <tr>
                  <td class="col-md-2">Video Title 2</td>
                  <td class="col-md-1">:</td>
                  <td class="col-md-4"><?= $package->package_video_title_2 ?></td>
                </tr>
                <tr>
