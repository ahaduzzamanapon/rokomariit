                    ...
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="amount" name="amount" value="<?= set_value('amount') ?>" placeholder="Enter Discount">
                            ...
                            <script>
                                var count = 0; // Counter to create unique input names
