        ...
        <?php echo form_open_multipart("admin/setting/edit/".$info->id);?>
          <div class="box-body">            
            ...
            <div class="col-md-9">
                  ...
                  <div class="form-group">
                    <label>Address</label>
                    <div><?php echo form_error('contact_address'); ?></div>
                    <textarea class="form-control" name="contact_address" value="<?=set_value('contact_address')?>"><?=$info->contact_address ?></textarea>
                  </div>
              ...
              <div class="col-md-3">
                ...
                <div class="form-group">
                  ...
                  <label style="color:red">Image Size: Width:250px  Height: 80px</label>                   
                  <p class="help-block">File type jpg, png, jpeg, gif and maximun file size 200 KB.</p>
                  <?php 
                ...
                <div class="form-group">
                  ...
                  <label style="color:red">Image Size: Width:64px, Height: 64px</label>  
                  <p class="help-block">File type jpg, png, jpeg, gif and maximun file size 100 KB.</p>
                  <?php 
                  $img_path = base_url().'setting_img/';
