    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          ...
          <a href="<?=base_url('admin/managementteam/all')?>" class="btn btn-info btn-xs pull-right" style="margin-left: 15px;"> All Management Team</a>
          <a href="<?=base_url('admin/managementteam/add')?>" class="btn btn-info btn-xs pull-right"> Add Management Team</a> 
        </div>        
        <?php echo form_open_multipart("admin/managementteam/edit/".$info->id);?>
          <div class="box-body">            
