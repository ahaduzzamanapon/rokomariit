                ...
                <td> 
                  <div class="btn-group">
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <li><a href="<?=base_url('admin/gallery/edit/'.$row->id)?>">Edit</a></li>
                        <li><a href="<?=base_url('admin/gallery/delete/'.$row->id)?>" onclick="return confirm('Are you sure you want to delete this gallery?');">Delete</a></li>
                      </ul>
                    </div>
                </td>
              </tr>
