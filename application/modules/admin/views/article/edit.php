    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          ...
          <a href="<?=base_url('admin/article/all')?>" class="btn btn-info btn-xs pull-right" style="margin-left: 15px;"> All Article</a>
          <a href="<?=base_url('admin/article/details/'.$info->id)?>" class="btn btn-info btn-xs pull-right" style="margin-left: 15px;"> Details Article</a>
          <a href="<?=base_url('admin/article/add')?>" class="btn btn-info btn-xs pull-right"> Add Article</a> 
        </div>        
        <?php echo form_open_multipart("admin/article/edit/".$info->id);?>
          <div class="box-body">            
