                ...
                <td> 
                  <div class="btn-group">
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <!-- <li><a href="<?=base_url('admin/testimonial/details/'.$row->id)?>">Details</a></li> -->
                        <li><a href="<?=base_url('admin/testimonial/edit/'.$row->id)?>">Edit</a></li>
                        <li><a href="<?=base_url('admin/testimonial/delete/'.$row->id)?>" onclick="return confirm('Are you sure you want to delete this Testimonial?');">Delete</a></li>
                      </ul>
                    </div>
                </td>
              </tr>
