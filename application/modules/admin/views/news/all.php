                ...
                <td> 
                  <div class="btn-group">
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <li><a href="<?=base_url('admin/news/edit/'.$row->id)?>">Edit</a></li>
                        <li><a href="<?=base_url('admin/news/delete/'.$row->id)?>" onclick="return confirm('Are you sure you want to delete this news?');">Delete</a></li>
                      </ul>
                    </div>
                </td>
              </tr>
